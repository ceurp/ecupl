[@panel name="业务系统" cssClass="nju-3"]
      ...
      <td width="100%" valign="top">
        <table align="center" cellspacing="1" cellpadding="2" border="0" style="width: 275px; height: 91px">
          <tbody>
            ...
            <tr height="23">
              [#list appRow as app]
              <td ><a target="_blank" href="${app.url?replace('{openurp.webapp}',webappBase)}"><img border="0" src="${static_base}/platform/0.0.5/images/app/default.gif">${app.title}</a></td>
              [/#list]
            </tr>
            [/#list]
          </tbody>
