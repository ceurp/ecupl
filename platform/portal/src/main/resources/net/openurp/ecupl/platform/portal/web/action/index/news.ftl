...
<table border="0" style="display:block" style="line-height:17pt" id='P-12860be1483-10001_1_content'>
        ...
        <tr>
          <td>
             <img src="${static_base}/images/news_item.gif">
...
<table style="display:none" border="0" style="line-height:17pt" id='P-12860be1483-10001_2_content'>
        ...
        [/#list]
        <tr><td colspan="2" align="right"><a title="更多" href="javaScript:var newwin=window.open('${examNewsUrl}')"><img width="41" height="11" border="0" src="${static_base}/images/index_15.jpg" id="ext-gen21"></a></td></tr>
    </tbody></table>
