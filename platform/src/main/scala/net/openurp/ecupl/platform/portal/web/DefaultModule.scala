...
import net.openurp.ecupl.platform.portal.web.action.{ AvatarAction, IndexAction, StudyAction, TeachingAction }
...
class DefaultModule extends BindModule {
  ...
  override def binding() {
    bind(classOf[IndexAction], classOf[AvatarAction], classOf[StudyAction], classOf[TeachingAction])
