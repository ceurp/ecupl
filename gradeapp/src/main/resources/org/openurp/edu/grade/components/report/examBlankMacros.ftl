...
<table align="center" style="text-align:center;margin-top:7px" cellpadding="0" cellspacing="0">
    ...
    <table width='100%' class="reportTitle" align='center' >
        ...
        <tr>
            ...
            <td>院系:[@i18nName clazz.enrollment.depart!/]</td>
...
[#macro gaReportFoot(clazz)]
  <table align="center" class="reportFoot" width="100%" style="height: 30px;">
      <tr>
      <td width="100%">统计人数:${courseTakers?size}</td>
     </tr>
  </table>
[/#macro]
...
<tr align="center" class="columnTitle">
 <td class="columnIndexTitle" width="8%">${b.text("attr.index")}</td>
 <td width="24%">${b.text("attr.stdNo")}</td>
 <td width="14%">${b.text("attr.personName")}</td>
 <td width="11%">修读类别</td>
 <td width="30%">学生签名</td>
 <td width="13%">备注</td>
</tr>
