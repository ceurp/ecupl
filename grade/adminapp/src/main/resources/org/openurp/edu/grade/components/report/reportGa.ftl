...
[#list reports as report]
  [#if report.courseGradeState??]
    ...
    [#else][#--全部重修--]
         [#assign squadMap = {retakeCourseGrades?first.std.squad.name:retakeCourseGrades?first.std.squad}/]
         [#assign squadCourseGrades = {retakeCourseGrades?first.std.squad.name:retakeCourseGrades}/]
